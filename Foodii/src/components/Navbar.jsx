        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-8">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link to="/restaurants" className="text-gray-600 hover:text-gray-900 font-medium">
                Restaurants
              </Link>
              <Link to="/offers" className="text-gray-600 hover:text-gray-900 font-medium">
                Offers
              </Link>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              to="/cart"
              className="p-2 rounded-full text-gray-500 hover:bg-gray-100 hover:text-gray-900 relative"
            >
